...
from paytrack.schemas import (ReceiverCreateSchema, ReceiverReadSchema,
...
class TestReceiverCreate:
    ...
    class TestInvalid:
        ...
        @pytest.mark.parametrize(
            "field", missing_field, ids=lambda f: f"ReceiverCreate_missing_field_{f}"
        )
...
class TestReceiverRead:
    ...
    class TestInvalid:
        ...
        @pytest.mark.parametrize(
            "field", missing_field, ids=lambda f: f"ReceiverRead_missing_field_{f}"
        )
        ...
        @pytest.mark.parametrize(
            "field, invalid_data", invalid, ids=lambda f: f"ReceiverRead_invalid_{f}"
        )
...
class TestReceiverUpdate:
    ...
    class TestInvalid:
        ...
        @pytest.mark.parametrize(
            "field, invalid_data", invalid, ids=lambda f: f"ReceiverUpdate_invalid_{f}"
        )
