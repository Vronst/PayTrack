...
from paytrack.schemas import (SettingCreateSchema, SettingReadSchema,
                              SettingUpdateSchema)
...
class TestSettingCreate:
    ...
    class TestInvalid:
        ...
        @pytest.mark.parametrize(
            "field,data", invalid_data, ids=lambda f: f"SettingCreate_invalid_value_{f}"
        )
...
class TestSettingRead:
    ...
    class TestInvalid:
        ...
        @pytest.mark.parametrize(
            "field,data", invalid_data, ids=lambda f: f"SettingRead_invalid_value_{f}"
        )
        def test_create_invalid_data(self, value, data, field):
            data = deepcopy(value)
            data[field] = data
